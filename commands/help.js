...
Command list\: \`help\`, \`test\`, \`horny\`, \`biden\`, \`trump\`, \`andrew\`, \`buff\`, \`user\`, \`pirate\`, \`invite\`, \`exe [insert text here]\`, \`genshin [insert genshin waifu here]\`, \`sm [insert character name here]\`, \`undelete [module]\`, \`count [@user]\`;
