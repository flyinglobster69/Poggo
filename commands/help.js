    ...
    found = false
        ...
        switch(primaryCommand.toLowerCase()) {
            case 'help' :
                ...
                Command list\: \`help\`, \`version\`, \`test\`, \`horny\`, \`biden\`, \`trump\`, \`andrew\`, \`buff\`, \`user\`, \`exe [insert text here]\`, \`genshin [insert genshin waifu here]\`, \`sm [insert character name here]\`, \`undelete [module]\`, \`count [@user]\`;
